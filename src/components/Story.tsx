export default function Story() {
  return (
    <section id="story">
      ...
      <p>
        I learned not through reading and taking notes, nor through imitating other coders in tutorials,
      ...
      <p>
        But it was always my dream to go deeper. By 2024, the apps that I could build were confined
      ...
      <p>
        At the start of a three-month holiday mid-2025, I returned rusty to my code editor from a period
      ...
      <p>
        This project turned out to be my big break! A senior developer who helped me with an issue
        that I posted to the mapping library that I was using checked out my project and sent an
